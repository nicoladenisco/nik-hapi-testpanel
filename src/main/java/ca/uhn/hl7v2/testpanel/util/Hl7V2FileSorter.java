...
public class Hl7V2FileSorter
{
  ...
  private void doSort(File inputFile, File outputFile, double theProgressStart, double theProgressEnd)
     throws FileNotFoundException, OperationCancelRequestedException, IOException
  {
    ...
    try
    {
      ...
      myProgressCallback.progressUpdate(1.0);
    }
    finally
    {
