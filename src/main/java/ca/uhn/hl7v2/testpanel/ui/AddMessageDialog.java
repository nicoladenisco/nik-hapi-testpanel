...
public class AddMessageDialog extends JDialog
{
  ...
  private void updateTypes()
  {
    ...
    try
    {
      if((structures = EventMapUtil.getEventMap(myCurrentSelectedVersion)) == null)
      {
        // ATTENZIONE: questo triggera un evento di cambiamento
        // richiamando nuovamente questa funzione: quindi usciamo subito dopo
        myVersionList.setSelectedValue(DEFAULT_VERSION, true);
        return;
      }
    }
