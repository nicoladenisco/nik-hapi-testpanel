...
class ValueCellRendererNew extends DefaultTableCellRenderer
{
  /**
   *
   */
  private final Hl7V2MessageTreeNew myTree;

  /**
   * @param theHl7v2MessageTree
   */
  public ValueCellRendererNew(Hl7V2MessageTreeNew theHl7v2MessageTree)
  {
