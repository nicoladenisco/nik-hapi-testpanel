...
public class Hl7V2MessageEditorPanel extends BaseMainPanel implements IDestroyable
{
  ...
  public Hl7V2MessageEditorPanel(final Controller theController)
  {
    ...
    mySpinnerIconOn
       = new ImageIcon(Hl7V2MessageEditorPanel.class.getResource("/ca/uhn/hl7v2/testpanel/images/spinner.gif"));
    ...
    mySendOptionsButton.addActionListener(new ActionListener()
    {
      ...
      public void actionPerformed(ActionEvent theE)
      {
        ...
        mySendOptionsPopupDialog
           = new SendOptionsPopupDialog(Hl7V2MessageEditorPanel.this, myMessage, mySendOptionsButton, sendOptionsHoverAdaptor);
    ...
    gbl_bottomPanel.columnWidths = new int[]
    {
      98, 74, 0
    };
    gbl_bottomPanel.rowHeights = new int[]
    {
      16, 0
    };
    gbl_bottomPanel.columnWeights = new double[]
    {
      0.0, 1.0, Double.MIN_VALUE
    };
    gbl_bottomPanel.rowWeights = new double[]
    {
